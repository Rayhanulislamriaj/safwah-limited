...
<head>
    ...
    <title>Safwah Limited - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3">Safwah Limited</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manu:</h6>
                        <a class="collapse-item" href="{{ route('admin.home') }}">Home</a>
                        <a class="collapse-item" href="{{ route('admin.about') }}">About</a>
                        <a class="collapse-item" href="{{ route('admin.service') }}">Goal</a>
                        <a class="collapse-item" href="{{ route('admin.concern') }}">Concern</a>
                        <a class="collapse-item" href="{{ route('admin.contact') }}">Contact</a>
                    </div>
                </div>
            </li>
            ...
            {{-- <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manu:</h6>
                        <a class="collapse-item" href="{{ route('brand.index') }}">Brand List</a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a target="_blank" class="nav-link" href="{{ route('index') }}">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a target="_blank" href="{{ route('index') }}"
                            class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-info fa-sm text-white-50"></i> Go to website</a>
                    </div>
                    @yield('content')
                </div>
            </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Safwah Limited</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
